...
<html lang="en">
  ...
  <body>
    <div class="container">
      <div class="row">
        <div class="col-4">
        <a href="index.php"><button type="button" id = "btn" class="btn btn-primary mt-3"
    ...
    <div class="row">
        ...
        <div class="bg-danger rounded-pill fs-4 fw-bold my-3  d-grid col-9 mx-auto text-center">Show Product</div>
