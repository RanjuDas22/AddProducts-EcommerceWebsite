...
?> -->
    ...
    <div class = "mb-3 ">
     <p class="text-center fw-bold fs-3 text-warning">Products Quantity Update</p>
    </div>
  <div class="mb-3 ">
...
<button name="update_quantity" class="bg-danger  rounded-pill fs-4 fw-bold my-3  d-grid col-9 mx-auto">Update</button>
</form>
